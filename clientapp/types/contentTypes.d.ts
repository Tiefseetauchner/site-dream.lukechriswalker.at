...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    name: Schema.Attribute.String;
    profile_picture: Schema.Attribute.Media<"images" | "files" | "videos" | "audios">;
    publishedAt: Schema.Attribute.DateTime;
    sitemap_exclude: Schema.Attribute.Boolean & Schema.Attribute.Private & Schema.Attribute.DefaultTo<false>;
    slug: Schema.Attribute.UID<"name">;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    url_alias: Schema.Attribute.Relation<"oneToMany", "plugin::webtools.url-alias"> & Schema.Attribute.Unique;
  };
}
...
export interface ApiBookBook extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    characters: Schema.Attribute.Relation<"manyToMany", "api::character.character">;
    content_warnings: Schema.Attribute.Text;
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::book.book"> & Schema.Attribute.Private;
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    imprint: Schema.Attribute.Blocks;
    links: Schema.Attribute.Relation<"oneToMany", "api::link.link">;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiPrivacyPrivacy extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "api::privacy.privacy"> & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginEzformsRecipient extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    email: Schema.Attribute.String &
      ...
      >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "plugin::ezforms.recipient"> & Schema.Attribute.Private;
    name: Schema.Attribute.String &
      Schema.Attribute.SetMinMax<
        {
          max: 50;
...
export interface PluginEzformsSubmission extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    formName: Schema.Attribute.String &
      ...
      >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "plugin::ezforms.submission"> & Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginWebtoolsAddonSitemapSitemap extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "plugin::webtools-addon-sitemap.sitemap"> & Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required & Schema.Attribute.DefaultTo<"default">;
    publishedAt: Schema.Attribute.DateTime;
    sitemap_string: Schema.Attribute.Text & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<["default_hreflang", "index"]> & Schema.Attribute.DefaultTo<"default_hreflang">;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
  };
}
...
export interface PluginWebtoolsUrlAlias extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<"oneToMany", "plugin::webtools.url-alias">;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<"oneToOne", "admin::user"> & Schema.Attribute.Private;
...
export interface PluginWebtoolsUrlPattern extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<"oneToMany", "plugin::webtools.url-pattern"> & Schema.Attribute.Private;
